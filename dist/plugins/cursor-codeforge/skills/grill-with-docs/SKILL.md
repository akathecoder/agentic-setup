...
Maintain all artifacts under `.agents/projects/<project>/`. Capture confirmed facts,
...
as project ADRs. Do not begin implementation or create tickets during this skill.
